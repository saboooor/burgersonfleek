    ...
    <section class="flex mx-auto max-w-6xl px-6 items-center justify-center min-h-[100svh] pt-20">
      ...
      <div class="text-center justify-center">
        <div class="flex sm:hidden relative justify-center align-center w-full">
          <div class="absolute -top-10 h-full w-64 h-64">
            <Blobs color="yellow" />
          </div>
        ...
        <h1 class="font-bold text-orange-100 text-3xl sm:text-5xl my-6 animate-in fade-in slide-in-from-top-16 sm:slide-in-from-top-8 anim-duration-1000" style="filter: drop-shadow(0 2rem 3rem rgba(251, 146, 60, 0.5));">
          The <span class="text-amber-500">burgers</span><br/>you are <span class="text-orange-300">craving.</span>
        </h1>
        <p class="text-gray-400 text-lg mx-6 md:mx-20 md:text-xl animate-in fade-in slide-in-from-top-24 sm:slide-in-from-top-16 anim-duration-1000">
        ...
        <div class="mt-10 space-y-3 min-h-[11.25rem] font-futura">
          <div class="flex gap-2 justify-center animate-in fade-in slide-in-from-top-32 sm:slide-in-from-top-24 anim-duration-1000">
          ...
          <div class="flex gap-2 justify-center animate-in fade-in slide-in-from-top-40 sm:slide-in-from-top-32 anim-duration-1000">
          ...
          <div class="flex gap-2 justify-center animate-in fade-in slide-in-from-top-48 sm:slide-in-from-top-40 anim-duration-1000">
