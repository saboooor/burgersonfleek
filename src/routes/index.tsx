...
export default component$(() => {
  ...
  return <>
    <section class="flex flex-col gap-4 mx-auto max-w-5xl px-6 items-center justify-center min-h-svh pt-24">
      <div class="flex flex-col sm:flex-row items-center sm:items-start gap-8 sm:gap-16">
      ...
      <div class="w-full flex justify-center animate-bounce text-burger-200">
