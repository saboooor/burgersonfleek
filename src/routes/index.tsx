...
export default component$(() => {
  ...
  return <>
    <section class="flex flex-col sm:flex-row gap-4 mx-auto max-w-6xl px-6 items-center justify-center min-h-svh pt-24">
      <div class="flex flex-col items-center animate-in fade-in slide-in-from-top-16 anim-duration-600 gap-4">
      ...
      <div class="flex flex-col sm:items-start sm:text-left items-center text-center">
        ...
        <p class="text-lum-text-secondary md:text-lg animate-in fade-in slide-in-from-top-16 anim-duration-800">
