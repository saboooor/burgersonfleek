  ...
  return (
    <section class="flex mx-auto max-w-6xl px-6 items-center justify-center min-h-[calc(100lvh)] pt-22 sm:pt-28">
      <div class="hidden sm:flex relative justify-start align-center mr-auto" style="max-width: 50%;">
        ...
        <div class="absolute left-0 right-0 mx-auto bottom-24 w-48 h-48 bg-yellow-400 rounded-full opacity-10 animate-blob ease-in-out filter blur-2xl -animation-delay-10000"></div>
        <div class="z-10 fade-in" style="max-width: 60%" >
      ...
      <div class="text-center justify-center">
        ...
        <h1 class="font-bold text-orange-100 text-3xl sm:text-5xl my-6 fade-in animation-delay-100" style="filter: drop-shadow(0 2rem 2rem rgba(251, 146, 60, 0.5));">
          The <span class="text-amber-500">burgers</span><br/>you are <span class="text-orange-300">craving.</span>
        </h1>
        <p class="text-gray-400 text-lg mx-6 md:mx-20 md:text-xl opacity-0 fade-in animation-delay-200">
        ...
        <div class="mt-10 space-y-3 min-h-[11.25rem] font-futura">
          ...
          <div class="flex gap-2 justify-center fade-in animation-delay-500">
