    ...
    <section class="flex mx-auto max-w-6xl px-6 items-center justify-center min-h-[calc(100lvh)] pt-22 sm:pt-28">
      ...
      <div class="text-center justify-center">
        <div class="flex sm:hidden relative justify-center align-center" style="width: 100%;">
          <div class="absolute -bottom-16 w-32 h-32 bg-orange-400 rounded-full opacity-10 animate-blob ease-in-out filter blur-lg" style="left: 45%"></div>
          <div class="absolute -bottom-16 w-32 h-32 bg-amber-400 rounded-full opacity-10 animate-blob ease-in-out filter blur-lg animation-delay-5" style="right: 50%"></div>
          <div class="absolute -bottom-16 w-32 h-32 bg-yellow-400 rounded-full opacity-10 animate-blob ease-in-out filter blur-lg animation-delay-10" style="left: 40%"></div>
          <div class="z-10">
