...
export default component$(() => {
  ...
  return <>
    <section class="flex flex-col sm:flex-row gap-4 mx-auto max-w-6xl px-6 items-center justify-center min-h-svh pt-24">
      <div class="flex flex-col items-center motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-600 gap-4">
      ...
      <div class="flex flex-col sm:items-start sm:text-left items-center text-center">
        <h1 class="font-bold text-white text-2xl sm:text-4xl mb-2 motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-700">
        ...
        <p class="text-lum-text-secondary md:text-lg motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-800">
          Premium Quality Gourmet Burgers, Steak Sandwiches, Fries, and more. est. 2019
        </p>

        <div class="flex flex-col gap-1 my-2 text-left">
          <div class="motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-900">
          ...
          <div class="motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1000">
          ...
          <div class="motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1100">
          ...
          <div class="motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1200">
          ...
          <div class="lum-btn lum-btn-p-1 lum-bg-transparent hover:lum-bg-gray-900/50 text-lum-text-secondary! min-h-13.5 motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1300">
            {GoogleDetails.value.currentOpeningHours?.openNow !== undefined &&
              <div class="*:motion-safe:animate-in *:fade-in *:anim-duration-800">
        ...
        <div class="flex flex-col items-center sm:items-start gap-1 sm:gap-2 font-futura">
          <OrderPopup class={{
            'motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1400': true,
          }} />
          <div class="motion-safe:animate-in fade-in slide-in-from-top-16 anim-duration-1500">
