  ...
  return (
    ...
    >
      ...
      <g fill="white" transform="translate(-252,-129)">
        ...
        >
          <path
            d="M514.5,272.6l-172.8,0.1c-2.6,0-5-0.6-7.1-1.7c0.8-1.5,1.9-3,3.1-4.2c1.7-1.8,3.8-3.2,6.1-4.3
        ...
        <g
          transform="translate(380,200) scale(0.5)"
          fill="var(--color-burger-500)"
        >
          <path d="M257.158,296.672v-14.273h-5.098v-2.906h13.652v2.906h-5.086v14.273H257.158z" />
          <path
            d="M267.916,296.672v-17.18h5.191l3.117,11.719l3.082-11.719h5.203v17.18h-3.223v-13.523
            l-3.41,13.523h-3.34l-3.398-13.523v13.523H267.916z"
          />
        </g>
        <g>
          <path
            d="M323.4,413.6V381h4.9c2.2,0,3.9,0.2,5.2,0.5c1.3,0.3,2.4,0.9,3.3,1.7c0.9,0.8,1.6,1.9,2.2,3.1c0.5,1.3,0.8,2.5,0.8,3.8
          ...
          />
          <path
            d="M355.6,381v19.6c0,2.8,0.5,4.8,1.4,6.1c1.4,1.9,3.3,2.8,5.8,2.8c2.5,0,4.4-0.9,5.8-2.8c0.9-1.3,1.4-3.3,1.4-6.1V381h4.9
            v21c0,3.4-1.1,6.3-3.2,8.5c-2.4,2.5-5.4,3.7-8.9,3.7s-6.4-1.2-8.8-3.7c-2.1-2.2-3.2-5-3.2-8.5v-21H355.6z"
          />
          <path
            d="M395.3,399.7l10.1,13.9h-6l-9.3-13.3h-0.9v13.3h-4.9V381h5.8c4.3,0,7.4,0.8,9.3,2.4c2.1,1.8,3.2,4.2,3.2,7.1
            c0,2.3-0.7,4.3-2,5.9S397.5,399.3,395.3,399.7z M389.2,396h1.6c4.7,0,7-1.8,7-5.3c0-3.3-2.3-5-6.8-5h-1.8V396z"
          />
          <path
            d="M428.1,396.7h13.5v1.1c0,2.4-0.3,4.6-0.9,6.5c-0.6,1.7-1.5,3.4-2.8,4.9c-3,3.4-6.9,5.1-11.5,5.1c-4.6,0-8.5-1.6-11.7-4.9
          ...
          <path
            d="M486.6,399.7l10.1,13.9h-6l-9.3-13.3h-0.9v13.3h-4.9V381h5.8c4.3,0,7.4,0.8,9.3,2.4c2.1,1.8,3.2,4.2,3.2,7.1
            c0,2.3-0.7,4.3-2,5.9C490.5,398.2,488.8,399.3,486.6,399.7z M480.5,396h1.6c4.7,0,7-1.8,7-5.3c0-3.3-2.3-5-6.8-5h-1.8V396z"
          />
          <path
            d="M521.7,385.9l-4,2.4c-0.7-1.3-1.5-2.1-2.1-2.5c-0.7-0.5-1.6-0.7-2.7-0.7c-1.4,0-2.5,0.4-3.4,1.2c-0.9,0.8-1.4,1.7-1.4,2.9
        ...
        <g>
          <path
            d="M351.1,457.7c-3.2,3.1-7.3,4.8-11.7,4.8c-4.5,0-8.6-1.7-11.7-4.8c-3.1-3.1-4.8-7.1-4.8-11.4c0-4.4,1.7-8.5,4.8-11.5
