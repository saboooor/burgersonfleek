          ...
          <div class="flex flex-1 items-center justify-end sm:items-stretch">
            <div class="sm:ml-6 sm:block">
              <div class="pointer-events-auto flex gap-2 text-gray-300">
                <Link href="/" class="transition duration-200 hidden bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md font-bold sm:flex items-center gap-4"><HomeIcon/>Home</Link>
                <Link href="/menu" class="transition duration-200 bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md font-bold flex items-center gap-4"><FileTextIcon/>Menu</Link>
              </div>
            </div>
          </div>
        </div>
