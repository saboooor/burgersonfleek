...
export default component$(() => {
  ...
  return (
    <Nav fixed class={{
      ...
      <ButtonAnchor q:slot="end" href="tel:+1 (905) 427 4377" transparent class={{ 'hidden sm:flex': true }}>
      ...
      <ButtonAnchor q:slot="mobile" href="tel:+1 (905) 427 4377" transparent>
        <IconInBag width="24" class="fill-current" /> ORDER
      </ButtonAnchor>
...
export const SocialButtons = component$(() => {
  return <>
    <ButtonAnchor transparent square href="https://instagram.com/burgersonfleek.ca" title="Instagram">
      <LogoInstagram width="24" />
    </ButtonAnchor>
    <ButtonAnchor transparent square href="https://facebook.com/burgersonfleek.ca" title="Facebook">
      <LogoFacebook width="24" />
    </ButtonAnchor>
    <ButtonAnchor transparent square href="https://tiktok.com/@burgersonfleek.ca" title="TikTok">
      <LogoTiktok width="24" />
    </ButtonAnchor>
    <ButtonAnchor transparent square href="https://maps.app.goo.gl/Unrrg3uda7AQQs4DA" title="Google Maps">
